...
import Vazhipokkan from "../../../public/stickman.svg";
      ...
      <div className="w-full mx-auto px-4 md:px-6 lg:px-16">
        <div className="flex justify-between h-16 items-center">
          {/* Logo */}
            <Link
              to="/"
              className="flex flex-row items-center md:text-[1.8rem] text-[1.4rem] text-orange-600 font-bold font-Macondo"
            > <img className="w-12 h-10 md:w-14 md:h-12 object-contain" src={Vazhipokkan} alt="Vazhipokkan Logo" />
