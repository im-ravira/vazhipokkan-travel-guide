...
const About = () => {
  ...
  return (
    <>
      <Navbar />
      <div>
        <img className="w-full md:h-screen h-72" src={CoverImage} alt="" />
      </div>
      <div className="bg-white md:px-16 px-8 py-12 text-gray-800">
        ...
        <div className="mb-12">
          <h3 className="md:text-2xl text-xl text-xl font-semibold mb-4">
        ...
        <div className="mb-12">
          <h3 className="md:text-2xl text-xl text-xl font-semibold text-gray-800 mb-6">
        ...
        <div className="mt-12 text-center">
          <p className="text-sm text-gray-600">
            This site is for educational purposes. To view more imformations of
            Tamil Nadu, visit{" "}
            <a
