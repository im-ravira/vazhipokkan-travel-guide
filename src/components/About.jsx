...
const About = () => {
  return (
    ...
    <div className="bg-white md:px-16 px-8 py-12 text-gray-800">
      <h2 className="md:text-2xl text-2xl text-center font-bold mb-6">
        About Tamil Nadu Tourism
      </h2>

      <section className="mb-12">
        <h3 className="text-2xl font-semibold mb-4">Welcome to Tamil Nadu!</h3>
        <p className="text-gray-700 text-sm md:text-base mb-4">
          A land where the echoes of ancient dynasties like the Cholas, Pandyas,
          and Pallavas still resonate, and where breathtaking landscapes,
          revered temples, and vibrant wildlife create an unforgettable
          connection with this diverse region of India. Tamil Nadu is often
          regarded as the cultural heart of India, known for its rich heritage
          and deep-rooted traditions.
        </p>
        <p className="text-gray-700 text-sm md:text-base mb-4">
          Explore the spiritual aura of its countless temples, relax on serene
          beaches and in peaceful hill stations, and experience the vitality of
          its diverse wildlife sanctuaries and national parks. The state's
          vibrant festivals, traditional art forms, and bustling markets add to
          its unique charm. Whether you're seeking spiritual fulfillment,
      ...
      <section className="mb-12">
        ...
        <p className="text-gray-700 text-sm md:text-base mb-4">
          ...
          state is home to many ancient temples, showcasing exquisite Dravidian
          architecture that has captivated visitors from around the world for
          centuries. Some of these temples are recognized as UNESCO World
          Heritage Sites, making Tamil Nadu a prime destination for those
          seeking spiritual enlightenment.
        </p>
        <p className="text-gray-700 text-sm md:text-base mb-4">
          The state is rich with sacred temples such as the Sri Ranganathaswamy
          Temple, Ekambareswarar Temple, Jambukeswarar Temple, Kailasanathar
          Temple, Thillai Nataraja Temple, Annamalaiyar Temple, and many more,
          each with a history that spans between 800 to 2,000 years. These
          architectural marvels are legacies of the Chola, Chera, Pandya,
          Pallava, Nayaka, and Vijayanagara dynasties.
        </p>
        <p className="text-gray-700 text-sm md:text-base mb-4">
          The tradition of temple building in Tamil Nadu began with the Pallavas
          in the 7th century AD. They introduced beautifully carved stone
          temples that continue to enhance the cultural landscape of the state.
          The Kailasanathar Temple and the Shore Temple are iconic examples of
          Pallava craftsmanship.
        </p>
        <p className="text-gray-700 text-sm md:text-base mb-4">
          The Cholas, who ruled from the 9th century AD, further enriched temple
          architecture by adding grand towers and expansive halls. The Great
          Living Chola Temples, now a UNESCO World Heritage Site, are must-visit
          landmarks that highlight Tamil Nadu’s rich architectural heritage.
          Later, the Vijayanagar and Nayaka rulers introduced intricate arches,
          pillars, and winding paths around these sacred sites.
        </p>
        <p className="text-gray-700 text-sm md:text-base">
          Among the most revered pilgrimage destinations in Tamil Nadu are the
          Meenakshi Amman Temple, Adi Kumbeswarar Temple, Brihadeeswarar Temple,
          Ramanathaswamy Temple, the group of Chola Temples, the temples of
          Mahabalipuram, and the Srivilliputhur Andal Temple. Each of these
          sites offers a unique glimpse into the spiritual and architectural
      ...
      <section className="mb-12">
        ...
        <p className="text-gray-700 text-sm md:text-base mb-4">
          ...
          Kotagiri, Velliangiri Hills, and Kolli Hills draw visitors throughout
          the year. Tamil Nadu also boasts stunning beaches that provide the
          perfect setting for a relaxing beach vacation. Whether it’s a peaceful
          stroll along the shore, capturing breathtaking sunsets, listening to
          the calming waves, enjoying water sports, or savoring fresh seafood,
          the beaches of Tamil Nadu offer simple yet profound pleasures.
        </p>
        <p className="text-gray-700 text-sm md:text-base mb-4">
      ...
      <section className="mb-12">
        ...
        <p className="text-gray-700 text-sm md:text-base mb-4">
          ...
          cultural tour in Tamil Nadu is incomplete without savoring its diverse
          cuisine, which extends beyond the well-known idli, dosa, and sambar to
          include delicious seafood, rice dishes, and a variety of vegetarian
          delights.
        </p>
        <p className="text-gray-700 text-sm md:text-base mb-4">
          ...
          cultural heritage. With 25 museums, observatories, and art galleries,
          there’s plenty to explore. Notable museums include the Gandhi Museum,
          Dakshinachitra Museum, India Seashell Museum, Kanyakumari Wax Museum,
          Chennai Rail Museum, Fort Museum, and the Click Art Museum, all
          offering unique insights into the region’s history and culture.
        </p>
        <p className="text-gray-700 text-sm md:text-base mb-4">
          ...
          World Heritage Sites like the Nilgiri Mountain Railway, the monuments
          of Mahabalipuram, and the Chola temples at Thanjavur, Darasuram, and
          Gangaikondacholapuram, are must-visit destinations that showcase the
        ...
        <ul className="space-y-4 text-gray-700 text-sm md:text-base list-inside">
          <li className="flex items-start">
            ...
            <p>
              ...
              including heritage monuments, churches, museums, pristine beaches,
              theme parks, and cafes.
            </p>
          </li>
          <li className="flex items-start">
            <p className="font-bold">Ooty-</p>
            <p>
          ...
          <li className="flex items-start">
            <p className="font-bold">Madurai-</p>
            <p>
          ...
          <li className="flex items-start">
            <p className="font-bold">Kodaikanal-</p>
            <p>
          ...
          <li className="flex items-start">
            <p className="font-bold">Rameshwaram-</p>
            <p>A spiritual haven known for the Shri Ramanathaswamy Temple.</p>
          </li>
          <li className="flex items-start">
            <p className="font-bold">Kanchipuram-</p>
            <p>Famous for its stunning temples and Kanchipuram silk sarees.</p>
          </li>
          <li className="flex items-start">
            <p className="font-bold">Coimbatore-</p>
            <p>
              Known as the ‘Manchester of South India’ and for its high-quality
              textiles and proximity to the Western Ghats.
            </p>
          </li>
          <li className="flex items-start">
            <p className="font-bold">Vellore-</p>
            <p>
          ...
          <li className="flex items-start">
            <p className="font-bold">Kanyakumari-</p>
            <p>
          ...
          <li className="flex items-start">
            <p className="font-bold">Mahabalipuram-</p>
            <p>
      ...
      <div className="mt-12 text-center">
          <p className="text-sm text-gray-600">
            This site is for educational purposes. To view more imformations of Tamil
            Nadu, visit{" "}
            <a
